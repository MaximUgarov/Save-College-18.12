                ...
                <div className="content-container-teamplatesPages center">
                    <div className="content-container-teamplatesPages-wrapp">
                        <div className="text-block-wrapper covid" style={{ "max-width": "1008px" }}>
                            ...
                            <div className="photo-block"><img src={ProgrammingPageArr.acf.img1.url} alt="" className="teamplete-photo" /><img src={ProgrammingPageArr.acf.img2.url} alt="" className="teamplete-photo" /></div>
                        </div>
                    </div>
                </div>
                <SubProgrammingPage />
